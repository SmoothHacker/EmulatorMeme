...
void disassembler::fileProcessor(FILE *fileInput) {
    fseek(fileInput, 0L, SEEK_END);
    this->fileSize = ftell(fileInput);
    fseek(fileInput, 0L, SEEK_SET);

    unsigned char *programCode= static_cast<unsigned char *>(malloc(this->fileSize));

    fread(programCode, this->fileSize, 1, fileInput);
    fclose(fileInput);
    std::cout << "File Size: " << this->fileSize << std::endl;
    this->programBuffer=programCode;
}
...
int disassembler::disassembleToConsole() {
    int opbytes = 1;
    ...
    switch (*code) {
        ...
        case 0x9: printf(""); break;
        case 0xa: printf(""); break;
        case 0xb: printf(""); break;
        case 0xc: printf(""); break;
        case 0xd: printf(""); break;
        case 0xe: printf(""); break;
        case 0xf: printf(""); break;
